  ...
  return (
    <footer>
      ...
      <div style={{ backgroundColor: "#1f1f1f" }}>
        <div className="px-8 md:px-[8%] lg:px-[12%] py-16 md:py-20">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-16 text-[10px]">
            <div>
              <p className="tracking-[0.2em] text-white/80 mb-5">CUISINES OF MOROCCO</p>
              <p className="text-white/70 text-sm leading-relaxed mb-4">
                The intelligence behind<br />Moroccan food.
              </p>
              <p className="text-white/60 text-xs">Marrakech, Morocco</p>
            </div>
            <div>
              <p className="tracking-[0.2em] text-white/80 mb-5">GUIDES</p>
            ...
            <div>
              <p className="tracking-[0.2em] text-white/80 mb-5">STORIES</p>
              <div className="space-y-3 text-white/90">
            ...
            <div>
              <p className="tracking-[0.2em] text-white/80 mb-5">CONNECT</p>
              <div className="space-y-3 text-white/90">
      ...
      <div style={{ backgroundColor: "#161616" }}>
        <div className="px-8 md:px-[8%] lg:px-[12%] py-3">
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
            <span className="text-[9px] tracking-[0.2em] text-white/90">EXPLORE</span>
        ...
        <div className="px-8 md:px-[8%] lg:px-[12%] py-3">
          <div className="flex flex-col md:flex-row items-center justify-between gap-3">
            <div className="flex items-center gap-4">
              {LEGAL_LINKS.map((link, i) => (
                <span key={link.label} className="flex items-center gap-4">
                  <Link href={link.href} className="text-[10px] text-white/85 hover:text-white transition-colors">
                    {link.label}
                  </Link>
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-[9px] tracking-[0.15em] uppercase text-white/90">
